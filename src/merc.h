...
/*
 * Bits for 'fortitude' clandisc
 */
#define	FORTITUDE_PERSONAL_ARMOR			1
#define	FORTITUDE_RESILIENT_MINDS			2
#define	FORTITUDE_ARMOR_OF_KINGS			4
#define	FORTITUDE_KING_OF_THE_MOUNTAIN		8
#define	FORTITUDE_REPAIR_UNDEAD_FLESH		16
#define	FORTITUDE_ARMORED_FLESH				32
#define	FORTITUDE_ARM_OF_PROMETHEUS			64
#define	FORTITUDE_STAND_AGAINST_ALL_FOES	128
#define	FORTITUDE_SHARED_STRENGTH			256
#define	FORTITUDE_ETERNAL_VIGILANCE			512

/*
 * Bits for 'auspex' clandisc
 */
#define	AUSPEX_HEIGHTENED_SENSES		1
#define	AUSPEX_AURA_PERCEPTION			2
#define	AUSPEX_PREDICTION				4
#define	AUSPEX_CLAIRVOYANCE				8
#define	AUSPEX_SPIRIT_TRAVEL			16
#define	AUSPEX_THE_MIND_REVEALED		32
#define	AUSPEX_ANIMA_GATHERING			64
#define	AUSPEX_ECSTATIC_AGONY			128
#define	AUSPEX_PSYCHIC_ASSAULT			256
#define	AUSPEX_MASTER_OF_THE_DOMINION	512

/*
 * Bits for 'animalism' clandisc
 */
#define	ANIMALISM_PACT_WITH_ANIMALS				1
#define	ANIMALISM_BECKONING						2
#define	ANIMALISM_QUELL_THE_BEAST				4
#define	ANIMALISM_SUBSUME_THE_SPIRIT			8
#define	ANIMALISM_DRAWING_OUT_THE_BEAST			16
#define	ANIMALISM_TAINTED_OASIS					32
#define	ANIMALISM_CONQUER_THE_BEAST				64
#define	ANIMALISM_TAUNT_THE_CAGED_BEAST			128
#define	ANIMALISM_UNCHAIN_THE_FEROCIOUS_BEAST	256
#define	ANIMALISM_FREE_THE_BEAST_WITHIN			512

/*
 * Bits for 'celerity' clandisc
 */
#define	CELERITY_QUICKNESS			1
#define	CELERITY_PRECISION			2
#define	CELERITY_MOMENTUM			4
#define	CELERITY_FLAWLESS_PARRY		8
#define	CELERITY_STUTTER_STEP		16
#define	CELERITY_FLOWER_OF_DEATH	32
#define	CELERITY_ZEPHYR				64
#define	CELERITY_PARAGON_OF_MOTION	128
#define	CELERITY_THE_UNSEEN_STORM	256
#define	CELERITY_BETWEEN_THE_TICKS	512

/*
 * Bits for 'obtenebration' clandisc
 */
#define	OBTENEBRATION_SHADOW_PLAY			1
#define	OBTENEBRATION_SHROUD_OF_NIGHT		2
#define	OBTENEBRATION_ARMS_OF_THE_ABYSS		4
#define	OBTENEBRATION_BLACK_METAMORPHOSIS	8
#define	OBTENEBRATION_SHADOWSTEP			16
#define	OBTENEBRATION_THE_DARKNESS_WITHIN	32
#define	OBTENEBRATION_INNER_DARKNESS		64
#define	OBTENEBRATION_TCHERNABOG			128
#define	OBTENEBRATION_AHRIMANS_DEMESNE		256
#define	OBTENEBRATION_BANISHMENT			512

/*
 * Bits for 'potence' clandisc
 */
#define	POTENCE_CRUSH						1
#define	POTENCE_THE_FIST_OF_LILLITH			2
#define	POTENCE_EARTHSHOCK					4
#define	POTENCE_AFTERSHOCK					8
#define	POTENCE_THE_FORGERS_HAMMER			16
#define	POTENCE_FIST_OF_THE_TITANS			32
#define	POTENCE_BRUTALITY					64
#define	POTENCE_LEND_THE_SUPERNATURAL_VIGOR	128
#define	POTENCE_MIGHT_OF_THE_HEROES			256
#define	POTENCE_TOUCH_OF_PAIN				512

/*
 * Bits for 'presence' clandisc
 */
#define	PRESENCE_AWE				1
#define	PRESENCE_DREAD_GAZE			2
#define	PRESENCE_MAJESTY			4
#define	PRESENCE_PARALYZING_GLANCE	8
#define	PRESENCE_SUMMON				16
#define	PRESENCE_BLOODLUST			32
#define	PRESENCE_PHOBIA				64
#define	PRESENCE_STAND_TALL			128
#define	PRESENCE_DREAM_WORLD		256
#define	PRESENCE_PURE_MAJESTY		512

/*
 * Bits for 'quietus' clandisc
 */
#define	QUIETUS_SCORPIONS_TOUCH						1
#define	QUIETUS_DAGONS_CALL							2
#define	QUIETUS_BAALS_CARESS						4
#define	QUIETUS_TASTE_OF_DEATH						8
#define	QUIETUS_EROSION								16
#define	QUIETUS_SELECTIVE_SILENCE					32
#define	QUIETUS_BLOOD_SWEAT							64
#define	QUIETUS_THIN_BLOOD							128
#define	QUIETUS_BLOOD_OF_DESTRUCTION				256
#define	QUIETUS_WEAKEN_THE_BLOOD_OF_THE_ANCIENTS	512

/*
 * Bits for 'thaumaturgy' clandisc
 */
#define	THAUMATURGY_GEOMANCY					1
#define	THAUMATURGY_SPARK						2
#define	THAUMATURGY_VERTIGO						4
#define	THAUMATURGY_CONTORTION					8
#define	THAUMATURGY_BLOOD_BOIL					16
#define	THAUMATURGY_RUNES_OF_POWER				32
#define	THAUMATURGY_ROUT_THE_CHARGING_HORDES	64
#define	THAUMATURGY_COGNIZANT_CONSTRUCTION		128
#define	THAUMATURGY_EYE_OF_THE_STORM			256
#define	THAUMATURGY_REGO_IGNEM					512

/*
 * Bits for 'vicissitude' clandisc
 */
#define	VICISSITUDE_MALLEABLE_VISAGE		1
#define	VICISSITUDE_FLESHCRAFT				2
#define	VICISSITUDE_BONE_CRAFT				4
#define	VICISSITUDE_FLESH_ROT				8
#define	VICISSITUDE_BREATH_OF_THE_DRAGON	16
#define	VICISSITUDE_BODY_ARSENAL			32
#define	VICISSITUDE_IMPALERS_FENCE			64
#define	VICISSITUDE_WILL_OVER_FORM			128
#define	VICISSITUDE_SKIN_TRAP				256
#define	VICISSITUDE_THE_LAST_DRACUL			512

/*
 * Bits for 'obfuscate' clandisc
 */
#define	OBFUSCATE_CLOAK_OF_SHADOWS				1
#define	OBFUSCATE_MASK_OF_A_THOUSAND_FACES		2
#define	OBFUSCATE_FADE_FROM_THE_MINDS_EYE		4
#define	OBFUSCATE_THE_SILENCE_OF_DEATH			8
#define	OBFUSCATE_CLOAK_THE_GATHERING			16
#define	OBFUSCATE_MANIFOLD_GUISE				32
#define	OBFUSCATE_FORTRESS_OF_SILENCE			64
#define	OBFUSCATE_MENTAL_MAZE					128
#define	OBFUSCATE_OBSCURE_GODS_CREATION			256
#define	OBFUSCATE_VEIL_OF_BLISSFUL_IGNORANCE	512
 ...
 */
DECLARE_DO_FUN(	do_personal_armor 	);
DECLARE_DO_FUN(	do_resilient_minds 	);
DECLARE_DO_FUN(	do_armor_of_kings 	);
DECLARE_DO_FUN(	do_king_of_the_mountain 	);
DECLARE_DO_FUN(	do_repair_undead_flesh 	);
DECLARE_DO_FUN(	do_armored_flesh 	);
DECLARE_DO_FUN(	do_arm_of_prometheus 	);
DECLARE_DO_FUN(	do_stand_against_all_foes 	);
DECLARE_DO_FUN(	do_shared_strength 	);
DECLARE_DO_FUN(	do_eternal_vigilance 	);
DECLARE_DO_FUN(	do_heightened_senses 	);
DECLARE_DO_FUN(	do_aura_perception 	);
DECLARE_DO_FUN(	do_prediction 	);
DECLARE_DO_FUN(	do_clairvoyance 	);
DECLARE_DO_FUN(	do_spirit_travel 	);
DECLARE_DO_FUN(	do_the_mind_revealed 	);
DECLARE_DO_FUN(	do_anima_gathering 	);
DECLARE_DO_FUN(	do_ecstatic_agony 	);
DECLARE_DO_FUN(	do_psychic_assault 	);
DECLARE_DO_FUN(	do_master_of_the_dominion 	);
DECLARE_DO_FUN(	do_pact_with_animals 	);
DECLARE_DO_FUN(	do_beckoning 	);
DECLARE_DO_FUN(	do_quell_the_beast 	);
DECLARE_DO_FUN(	do_subsume_the_spirit 	);
DECLARE_DO_FUN(	do_drawing_out_the_beast 	);
DECLARE_DO_FUN(	do_tainted_oasis 	);
DECLARE_DO_FUN(	do_conquer_the_beast 	);
DECLARE_DO_FUN(	do_taunt_the_caged_beast 	);
DECLARE_DO_FUN(	do_unchain_the_ferocious_beast 	);
DECLARE_DO_FUN(	do_free_the_beast_within 	);
DECLARE_DO_FUN(	do_quickness 	);
DECLARE_DO_FUN(	do_precision 	);
DECLARE_DO_FUN(	do_momentum 	);
DECLARE_DO_FUN(	do_flawless_parry 	);
DECLARE_DO_FUN(	do_stutter_step 	);
DECLARE_DO_FUN(	do_flower_of_death 	);
DECLARE_DO_FUN(	do_zephyr 	);
DECLARE_DO_FUN(	do_paragon_of_motion 	);
DECLARE_DO_FUN(	do_the_unseen_storm 	);
DECLARE_DO_FUN(	do_between_the_ticks 	);
DECLARE_DO_FUN(	do_shadow_play 	);
DECLARE_DO_FUN(	do_shroud_of_night 	);
DECLARE_DO_FUN(	do_arms_of_the_abyss 	);
DECLARE_DO_FUN(	do_black_metamorphosis 	);
DECLARE_DO_FUN(	do_shadowstep 	);
DECLARE_DO_FUN(	do_the_darkness_within 	);
DECLARE_DO_FUN(	do_inner_darkness 	);
DECLARE_DO_FUN(	do_tchernabog 	);
DECLARE_DO_FUN(	do_ahrimans_demesne 	);
DECLARE_DO_FUN(	do_banishment 	);
DECLARE_DO_FUN(	do_crush 	);
DECLARE_DO_FUN(	do_the_fist_of_lillith 	);
DECLARE_DO_FUN(	do_earthshock 	);
DECLARE_DO_FUN(	do_aftershock 	);
DECLARE_DO_FUN(	do_the_forgers_hammer 	);
DECLARE_DO_FUN(	do_fist_of_the_titans 	);
DECLARE_DO_FUN(	do_brutality 	);
DECLARE_DO_FUN(	do_lend_the_supernatural_vigor 	);
DECLARE_DO_FUN(	do_might_of_the_heroes 	);
DECLARE_DO_FUN(	do_touch_of_pain 	);
DECLARE_DO_FUN(	do_awe 	);
DECLARE_DO_FUN(	do_dread_gaze 	);
DECLARE_DO_FUN(	do_majesty 	);
DECLARE_DO_FUN(	do_paralyzing_glance 	);
DECLARE_DO_FUN(	do_presence_summon 	);
DECLARE_DO_FUN(	do_bloodlust 	);
DECLARE_DO_FUN(	do_phobia 	);
DECLARE_DO_FUN(	do_stand_tall 	);
DECLARE_DO_FUN(	do_dream_world 	);
DECLARE_DO_FUN(	do_pure_majesty 	);
DECLARE_DO_FUN(	do_scorpions_touch 	);
DECLARE_DO_FUN(	do_dagons_call 	);
DECLARE_DO_FUN(	do_baals_caress 	);
DECLARE_DO_FUN(	do_taste_of_death 	);
DECLARE_DO_FUN(	do_erosion 	);
DECLARE_DO_FUN(	do_selective_silence 	);
DECLARE_DO_FUN(	do_blood_sweat 	);
DECLARE_DO_FUN(	do_thin_blood 	);
DECLARE_DO_FUN(	do_blood_of_destruction 	);
DECLARE_DO_FUN(	do_weaken_the_blood_of_the_ancients 	);
DECLARE_DO_FUN(	do_geomancy 	);
DECLARE_DO_FUN(	do_spark 	);
DECLARE_DO_FUN(	do_vertigo 	);
DECLARE_DO_FUN(	do_contortion 	);
DECLARE_DO_FUN(	do_blood_boil 	);
DECLARE_DO_FUN(	do_runes_of_power 	);
DECLARE_DO_FUN(	do_rout_the_charging_hordes 	);
DECLARE_DO_FUN(	do_cognizant_construction 	);
DECLARE_DO_FUN(	do_eye_of_the_storm 	);
DECLARE_DO_FUN(	do_rego_ignem 	);
DECLARE_DO_FUN(	do_malleable_visage 	);
DECLARE_DO_FUN(	do_fleshcraft 	);
DECLARE_DO_FUN(	do_bone_craft 	);
DECLARE_DO_FUN(	do_flesh_rot 	);
DECLARE_DO_FUN(	do_breath_of_the_dragon 	);
DECLARE_DO_FUN(	do_body_arsenal 	);
DECLARE_DO_FUN(	do_impalers_fence 	);
DECLARE_DO_FUN(	do_will_over_form 	);
DECLARE_DO_FUN(	do_skin_trap 	);
DECLARE_DO_FUN(	do_the_last_dracul 	);
DECLARE_DO_FUN(	do_cloak_of_shadows 	);
DECLARE_DO_FUN(	do_mask_of_a_thousand_faces 	);
DECLARE_DO_FUN(	do_fade_from_the_minds_eye 	);
DECLARE_DO_FUN(	do_the_silence_of_death 	);
DECLARE_DO_FUN(	do_cloak_the_gathering 	);
DECLARE_DO_FUN(	do_manifold_guise 	);
DECLARE_DO_FUN(	do_fortress_of_silence 	);
